...
public class Utils_Alert {
	...
	public static void showSimple(Context context ,int msg){
		showAlertDialog(context,android.R.string.dialog_alert_title,msg,true,android.R.string.ok,null,0,null,null);
	}
