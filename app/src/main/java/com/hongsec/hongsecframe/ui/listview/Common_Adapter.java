...
public abstract class Common_Adapter<T>  extends BaseAdapter{
	...
	protected View getDefault_view(int position, View convertView,
			ViewGroup parent) {
			Common_Viewholder holder=Common_Viewholder.getInstance(context, convertView, parent,layoutid, position);
	 ...
	 * @param data
	 */
	public abstract void getDefaultView(Common_Viewholder holder,int position,T data) ;
